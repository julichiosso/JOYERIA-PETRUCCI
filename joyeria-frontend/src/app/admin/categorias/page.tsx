          ...
          {categories.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 font-sans">
              {categories.map((cat, rootIndex) => (
                <div
                  key={cat.id}
                  className="bg-white border border-[#E5E5EA] rounded-3xl p-5 shadow-2xs flex flex-col justify-between hover:border-gray-300 transition-all gap-4"
                >
                  {/* Cabecera del Bento Box con Posición en Menú */}
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between gap-2 border-b border-[#F5F5F7] pb-3">
                      <div className="flex items-center gap-2.5 min-w-0">
                        {/* Insignia de Orden/Posición */}
                        <span className="text-[11px] font-extrabold text-[#007AFF] bg-blue-50 border border-blue-100 px-2.5 py-1 rounded-xl shrink-0 font-mono">
                          #{rootIndex + 1}
                        </span>
                      ...
                      <div className="flex items-center gap-1.5 shrink-0">
                        {/* Botones táctiles de reordenamiento (Cajas Japonesas) */}
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="w-9 h-9 flex items-center justify-center bg-[#F5F5F7] border border-[#E5E5EA] hover:bg-gray-200/80 active:scale-95 text-[#1D1D1F] rounded-xl text-xs font-bold disabled:opacity-20 transition-all cursor-pointer min-w-[36px]"
                          >
                        ...
                        <button
                          ...
                          className="px-2.5 py-2 bg-[#F5F5F7] border border-[#E5E5EA] text-[#1D1D1F] hover:bg-gray-200 text-[11px] font-semibold rounded-xl transition-colors cursor-pointer shrink-0 min-h-[36px]"
                        >
                            ...
                            <div className="flex items-center gap-2 truncate">
                              <div className="flex items-center gap-1 shrink-0">
                                <button
                                  ...
                                  disabled={subIndex === 0}
                                  className="w-6 h-6 flex items-center justify-center text-[#1D1D1F] hover:bg-gray-200 bg-white rounded-lg border border-gray-200 disabled:opacity-20 font-bold cursor-pointer active:scale-90 transition-transform"
                                  title="Subir"
                                >
