            ...
            <div className="mx-auto max-w-7xl px-4 md:px-8">
                ...
                {products.length > 0 ? (
                    ...
                    <div className="bg-white rounded-2xl p-12 text-center border border-gray-200/80 my-8 max-w-md mx-auto shadow-2xs">
                        ...
                        <Link
                            href="/productos"
                            className="inline-flex items-center justify-center px-6 py-2.5 bg-gray-950 text-white font-body text-xs font-semibold tracking-wider uppercase rounded-lg hover:bg-black transition-colors"
                        >
