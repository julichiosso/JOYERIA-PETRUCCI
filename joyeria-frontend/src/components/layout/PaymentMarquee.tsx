...
const paymentLogos = [
  ...
  {
    name: "Mastercard",
    svg: `<svg width="29" height="17" viewBox="0 0 40 24" xmlns="http://www.w3.org/2000/svg"><rect width="40" height="24" rx="4" fill="#252525"/><circle cx="15" cy="12" r="7" fill="#EB001B"/><circle cx="25" cy="12" r="7" fill="#F79E1B"/><path d="M20 6.8a7 7 0 0 1 0 10.4A7 7 0 0 1 20 6.8z" fill="#FF5F00"/></svg>`,
  },
  {
    name: "Naranja X",
    svg: `<svg width="50" height="17" viewBox="0 0 70 24" xmlns="http://www.w3.org/2000/svg"><rect width="70" height="24" rx="4" fill="#FF6200"/><text x="8" y="16" font-size="11" font-weight="900" fill="#fff" font-family="Arial">naranja</text><text x="52" y="16" font-size="13" font-weight="900" fill="#fff" font-family="Arial">X</text></svg>`,
  },
  {
    name: "MODO",
    svg: `<svg width="46" height="17" viewBox="0 0 65 24" xmlns="http://www.w3.org/2000/svg"><rect width="65" height="24" rx="4" fill="#001F5B"/><path d="M8 17V7l5 6 5-6v10" fill="none" stroke="#00C2FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><text x="22" y="16" font-size="10" font-weight="800" fill="#fff" font-family="Arial">MODO</text></svg>`,
  },
  {
    name: "Cabal",
    svg: `<svg width="50" height="17" viewBox="0 0 70 24" xmlns="http://www.w3.org/2000/svg"><rect width="70" height="24" rx="4" fill="#003087"/><circle cx="16" cy="12" r="6" fill="#E31837" fill-opacity="0.9"/><circle cx="22" cy="12" r="6" fill="#FDB913" fill-opacity="0.9"/><text x="30" y="16" font-size="9" font-weight="800" fill="#fff" font-family="Arial">CABAL</text></svg>`,
  },
  {
    name: "American Express",
    svg: `<svg width="39" height="17" viewBox="0 0 55 24" xmlns="http://www.w3.org/2000/svg"><rect width="55" height="24" rx="4" fill="#0070D2"/><text x="6" y="16" font-size="9" font-weight="900" fill="#fff" font-family="Arial" letter-spacing="0.5">AMERICAN</text><text x="6" y="22" font-size="5" font-weight="700" fill="#fff" font-family="Arial" letter-spacing="1.5">EXPRESS</text></svg>`,
  },
  {
    name: "Rapipago",
    svg: `<svg width="43" height="17" viewBox="0 0 60 24" xmlns="http://www.w3.org/2000/svg"><rect width="60" height="24" rx="4" fill="#fff" stroke="#e5e7eb" stroke-width="1"/><text x="4" y="16" font-size="10" font-weight="900" font-style="italic" fill="#005CA9" font-family="Arial">rapi</text><text x="26" y="16" font-size="10" font-weight="900" font-style="italic" fill="#E30613" font-family="Arial">pago</text></svg>`,
  },
];
