 ...
 * Sección "NOVEDADES" del home con soporte completo de esqueletos de carga.
 */
    ...
    <section className="bg-white py-10 sm:py-14 border-b border-gray-100 min-h-[380px]" aria-label="Novedades de la tienda">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        {loading ? (
          ...
          /* ── Estado Sin Productos (elegante y con mensaje claro) ────────── */
          <div className="py-12 text-center flex flex-col items-center justify-center">
            <p className="text-gray-500 font-body text-sm">
              Pronto sumaremos nuevas piezas exclusivas a nuestro catálogo.
            </p>
          </div>
        )}
      </div>
